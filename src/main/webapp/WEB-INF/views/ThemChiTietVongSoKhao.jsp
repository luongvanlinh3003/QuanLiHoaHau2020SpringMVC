...
<body>
    ...
    <div align="center">
        <h2>Nhập điểm thi vòng sơ khảo hoa hậu hoàn vũ 2020</h2>
        
        <form:form action="save" method="post" modelAttribute="chitietvongsokhao" enctype="multipart/form-data">
            <table border="0" cellpadding="5">
                ...
                <tr>
                    <td>Điểm hình thể: </td>
                    <td><form:input path="DiemHinhThe" /></td>
                </tr>
                <tr>
                    <td>Điểm trả lời phỏng vấn: </td>
                    <td><form:input path="DiemTraLoiPhongVan" /></td>
                </tr>
                <tr>
                    <td>Điểm Catwalk theo nhạc: </td>
                    <td><form:input path="DiemCatwalkTheoNhac" /></td>
                </tr>  
               
               <tr>
                    <td>Điểm Catwalk theo nhạc: </td>
                    <td><form:input path="DiemTrungBinh" /></td>
                </tr>  
                <tr>
