    ...
    <thead style="font-size: 11px;text-align: center;">	
     ...
     <tbody style="font-size: 11px; text-align: center;">   
        ...
        <tr>
            ...
            <td><fmt:formatDate pattern = "dd-MM-yyyy"  value = "${thisinh.getNgaySinh()}" /></td>
            <td>${thisinh.getDiaChi()}</td>
            <td>${thisinh.getEmail()}</td>
            <td>${thisinh.getSoDienThoai()}</td>
            <td><img alt="" width="80px" height="80px" style="margin: 0" src="<c:url value="/resources/image/${thisinh.getAnhChanDung()}"/>"></td>
            <td>${thisinh.getTrinhDo()}</td>
            <td>${thisinh.getSoDoVong1()}</td>
            <td>${thisinh.getSoDoVong2()}</td>
