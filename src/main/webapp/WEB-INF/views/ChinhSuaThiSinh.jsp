...
<body>
    ...
    <div align="center">
        <h2>Cập nhật thông tin thí sinh dự thi hoa hậu hoàn vũ 2020</h2>
        
        <form:form action="edit" method="post" modelAttribute="thisinhduthi" enctype="multipart/form-data">
            <table border="0" cellpadding="5">
                <tr>
                    <td>Mã thí sinh: </td>
                    <td>${thisinhduthi.getMaThiSinh()}<form:hidden path="MaThiSinh" /></td>
                </tr>
                <tr>
                    <td>Tên thí sinh: </td>
                ...
                <tr>
                    <td>Ngày sinh: </td>
                    <td><input type="date" value="<c:out value="${thisinhduthi.getNgaySinh()}"></c:out>" name="NgaySinh"/></td>
                </tr>  
                <tr>
                    <td>Số điện thoại: </td>
            	...
            	<tr>               	
                    	<td><form:hidden path="AnhChanDung"/></td>               
                </tr>  
