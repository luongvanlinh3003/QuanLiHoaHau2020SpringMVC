...
<body>
    ...
    <h3><a id ="clickDtb" href="/QuanLiHoaHau2020/admin/quanlivongbanket/diemtrungbinh">Tổng điểm vòng sơ khảo</a></h3>
    ...
    <thead>	
        <tr>
            ...
            <th>Tổng điểm vòng bán kết</th> 
            <th>Chức năng</th>
        </tr>
     </thead>
     <tbody>
        <c:forEach items="${listDtbVongBanKet}" var="thisinh" varStatus="itr">
        <tr>
