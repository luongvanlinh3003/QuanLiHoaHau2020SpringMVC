...
<title>Cập nhật Điểm Vòng Bán Kết</title>
...
<body>
    ...
    <div align="center">
        ...
        <form:form action="edit" method="post" modelAttribute="chitietvongbanket" enctype="multipart/form-data">
            <table border="0" cellpadding="5">
                <tr>
                    <td>Mã thí sinh: </td>
                    <td>${chitietvongbanket.getMaThiSinh()}<form:hidden path="MaThiSinh" /></td>
                </tr>
                ...
                <tr>
                    <td>Điểm Trang Phục Áo Dài: </td>
                    <td><form:input path="DiemTrangPhucAoDai" /></td>
                </tr>
                <tr>
                    <td>Điểm Trang Phục Áo Tắm: </td>
                    <td><form:input path="DiemTrangPhucAoTam" /></td>
                </tr>
                <tr>
                    <td>Điểm Trang Phục Dạ Hội: </td>
                    <td><form:input path="DiemTrangPhucDaHoi" /></td>
                </tr>  
